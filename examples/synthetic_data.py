"""Synthetic right-censored survival data, for demonstrations and tests.

Lives in ``examples/`` rather than in ``kalecancer``: generating data with a known
answer is how you exercise a pipeline, not something the pipeline provides. Nothing
