"""Config-driven HANCOCK tabular survival: load, encode, and train a Cox head.
...
Run with:
    ...
    python -m examples.hancock_tabular_survival.pipeline
...
from examples.hancock_tabular_survival.config_handler import (
    build_cohort,
    build_embedder,
    build_head,
    build_optimiser,
