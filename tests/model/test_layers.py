...
``BagEncoder`` appears here because the adapter and the block it wraps are only
meaningful together: the encoder exists to keep the pooler's attention weights
reachable after a forward pass.
"""
