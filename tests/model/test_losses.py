"""Tests for ``kalecancer.model.predict.losses``."""
...
from kalecancer.model.embed import MultimodalOutput
from kalecancer.model.predict.losses import multimodal_bce_loss, neg_partial_log_likelihood
